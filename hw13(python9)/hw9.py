...
prog = r"\b[п]рограммир(ова(в(ш((ий|ая|ее|его|ему|им|ем|ей|ую|ей)(ся)?|и(сь)?))?|ть|л(ся|[аои](сь)?)?)|у(ю(сь|(т|щ(ий|ая|ее|его|ему|им|ем|ую|ей|))(ся)?)?|е((шь|т|м)(ся)?|те(сь)?)|я(сь)?))\b"
